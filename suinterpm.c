...
char *sdoc[] = { 
"									",
" SUINTERPM - interpolate traces using automatic event picking		",
"									",
...
" dx             0 increase in offset sampling for interp traces        ",
"									",
...
main (int argc, char **argv)
{
	...
	if (!getparfloat("dx", &dx)) dx = 0; /* Added - Trad */
