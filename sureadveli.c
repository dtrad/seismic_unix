...
char *sdoc[] = {
  " 	   								",
  " SUREADVELI - writes velocity sufile from parfile                    ",
  "                                                                     ", 
  "	                                                          	",
  " 	   								",
  " sureadveli < stdin > stdout [optional parameters]          		",
  " 									",
  " cdpmin=0        Fisrt CDP in meters                                 ",
  " cdpmax=100      Last CDP 						",
  " par=            file with stacking velocities and time as obtained  ",
  "                 from Velan                                          ",
  " dxcdp=10        horizontal output sampling in cdp numbers           ",
  "                                                                     ",
...
int main(int argc, char **argv)
{
  ...
  for(ix=0;ix<nx;ix++) x[ix]=cdpmin+dxcdp*ix;
  fprintf(stderr,"dxcdp=%f,cdpmin=%f\n",dxcdp,cdpmin);
