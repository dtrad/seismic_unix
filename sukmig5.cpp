...
char *sdoc[] = {
  " 	   								",
  " SUkMIG5                   - Kirchoff  migration                     ",
  "                                                                     ", 
  "	                                                          	",
  " 	   								",
  " sukmig5 < stdin > stdout [optional parameters]          		",
  " 									",
...
{ 
  ...
  do {
    ...
    kmig3(d,cdptr,h,m,t,x,ivel2,nt,nx,dt,cdpspace,aper);
    if (fmod(tr.tracl,100.)==0) fprintf(stderr,"tr.tracl=%d\n",tr.tracl);
