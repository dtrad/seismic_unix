...
int main(int argc, char **argv)
{
  ...
  for (ix=0;ix<nx;ix++){
    ...
    if (mute==1) // Multiple removal
      radonfreqint(he,nhcmp[ix],cmp,t,nt,dt,velatcmp,eps1,eps2,eps,mm,q,nq,itercg,iter_end,step,lsmethod,factor,smute,nmofactor,mute,parmute,he,nhcmp[ix]);
    else         // Interpolation
    ...
    if (mute==0) sethflag2(hflag,nhe,he,nhe,h2,nh2,under,over);
