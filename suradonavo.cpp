...
char *sdoc[] = {
  " 	   								",
  " SURADONEOM - Time domain hyperbolic Radon Transform                 ",
  "                                                                     ",
  " 	   								",
  " suradoneom < stdin > stdout [optional parameters]       		",
  "                                                                     ",
  " IMPORTANT:****************************************                  ",
  " Input must be sort by cdp and offset, for example                   ",
  "                   susort cdp offset < input | .....                 ",
  "                                                                     ",
  " This program removes non hyperbolic signal from seismic gathers     ",
  " In principle is designed to work with Common Scatter Point gathers  ",
  " There are a subproduct of Equivalent Offset Migration.              ",
  " The filtering effect is achieved by thresholding in the Radon domain",
  "                                                                     ",
  ...
  " parmute=1e-8    if m(q,t) is < parmute the the model is eliminated  ",
  ...
  " Example: 		                                                ",
  "                                                                     ",
  "  suradonlinetd < $FILE  cdpmin=$CDP cdpmax=$CDP dxcdp=$dxcdp        ",
  "  nhcdp=$nhcdp par=$par itercg=$itercg iter_end=$iter_end eps2=$eps2 ",
