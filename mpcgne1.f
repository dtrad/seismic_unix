...
c     Daniel Trad - May 2000
      ...
      call mpcgne(A,n,m,x,b,MI,tol,lambda,step,itercg,restart)
      ...
      subroutine mpcgne(A,n,m,x,b,MI,tol,lambda,step,itercg,restart)
...
c     (A MI A^T + lambda I ) u = b  with x=A^T u
c
