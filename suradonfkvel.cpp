...
char *sdoc[] = {
  " 	   								",
  " SURADONFKVEL  RT for  apex shifted hyperbolas  with LS square      ",
  "              time migration Stolt fk operator                       ",
  " It is similar to suradonfk0, but the purpose of this version is to  ",
  " solve the CG algorithm in the freq-wavenumber domain                ",
  " directly if time-offset domain is not going to be enforced.         ",
  " I expect to have better convergence properties with this change,    ",
  " as well as improving efficiency and decreasing artifact creation.   ",
  " At present, this code has not difference with suradonfk0            ",
  " 	   								",
  " suradonfkvel  < stdin > stdout [optional parameters]          	",
  " 									",
  " Elimination of apex shifted hyoerbolas by using least squares       ",
  " Stolt migration.                                                    ",
  " If the original gather has gaps then the program sufill             ",
  " is used to add zero traces into these gaps.                         ",
  " Note that this code is very similat to suinterpfk0 but it is not    ",
  ...
  " the mute filter are added, including plotting                       ",
  ...
  " such that convergence and artifact creation can be studied with care", 
  "                                                                     ",
  ...
  " tmig=0          Time for velocity trend                             ",
  ...
  "                                                                     ",
  "   suradonfkvel < tempfile vmig=3600,3000 tmig=0,4 plot=1              ",
...
int main(int argc, char **argv)
{
  ...
  if (!getparfloat("vmig",vmig)) vmig[0]=4000.0;
 ...
 */
  ...
  /********************************************************/
  TRACE;
  stoltz_wtcgls(datains,dataouts,Wds,h,nh,tu,nu,vel,inv);
