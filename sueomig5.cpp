...
//////////////////////////////////////////////////////////////////
// Function Prototypes
void eomigls_sparse(float *m,float *m,float *t, float *h, float *q, float *vel,
...
int main(int argc, char **argv)
{
  ...
  for (ix=0;ix<nx;ix+=ncsp){
	...
	eomigls_sparse(m,mm,t,he,q,velatcsp[icsp],csp[icsp],nt,nhcsp,nq,fmax,step,eps,eps1,eps2,itercg,iter_end,smooth,testadj,buffer,pervmin,dperv,norm,nmute,mute);

      if (output==6) 
	eomgetvel(m,mm,t,he,q,velatcsp[icsp],csp[icsp],nt,nhcsp,nq,fmax,step,eps,eps1,eps2,itercg,iter_end,smooth,testadj,buffer,pervmin,dperv,norm);    
