...
bool process(float** datain, float** dataout, int nt, int  nx, float dt){
  ...
  float B_fw11, B_fw12, B_fw13, B_fw21, B_fw22, B_fw23, B_fw31, B_fw32, B_fw33 ;

  B_fw11 = 1/sqrt(3); // the first vector of the new basis [1/sqrt(3) 1/sqrt(3) 1/sqrt(3)]
  B_fw12 = 1/sqrt(3); 
  B_fw13 = 1/sqrt(3);
  B_fw21 = 0;         // the second vector of the new basis [0 1/sqrt(2) -1/sqrt(2)] (orthogonal to the first)
  B_fw22 = 1/sqrt(2);
  B_fw23 = -1/sqrt(2);
  B_fw31 = -1*(B_fw12*B_fw23 - B_fw13*B_fw22); // the third vector of the new basis, -1*(row1Xrow2) = orthogonal to the first two by definition
  B_fw32 = -1*(B_fw13*B_fw21 - B_fw11*B_fw23);
  B_fw33 = -1*(B_fw11*B_fw22 - B_fw12*B_fw21);
