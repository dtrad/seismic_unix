...
void save_gather(float **d, int nh, float *h, int nt, float dt, const char* name)
{
...
void save_gather(float ***d, int nx, float *vel, int nh, float *h, int nt, float dt, const char* name)
{
...
void save_gather(float ***d, int nx, float *vel, int nh, float *h, int nt, float *t, const char* name)
{
  /* Save a 3 dimensional gather including the header words for all axes */
...
void save_gather(float ***d, int nx, int nh, int nt, float dt, const char* name)
{
