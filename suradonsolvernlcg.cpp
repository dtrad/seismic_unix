...
char *sdoc[] = {
  " 	   								",
  " SURADONSOLVER - Frequency domain Parabolic Radon Transform              ",
  " 	   								",
...
int main(int argc, char **argv)
{
  ...
  if (!getparstring("solver",&solver)) solver="nlcg__";
  ...
  else if (STREQ(solver,"nlcg")) solver="nlcg__";
  ...
  radonsolvernlcg0(data,h,nh,t,nt,dt,model,q,nq,velint,itercg,iter_end,step,eps2,eps1, 
