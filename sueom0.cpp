...
char *sdoc[] = {
  " 	   								",
  " SUEOM - Equivalent Offset migration                                 ",
  " 	   								",
  " sucsp < stdin > stdout [optional parameters]          		",
  " 									",
  " cdpmin=0        First CDP in meters                                 ",
  " cdpmax=100      Last CDP 						",
  " cdpspace=1      Physical distance  between two cdp numbers          ",
  " par=            file with RMS velocities and time as obtained       ",
  "                 from Velan                                          ",
  "                                                                     ",
  " output=2        =0 test - Output=input                              ",
  "                 =1 plot and save CSPs in csps.su                    ",
  "                 =2 CSP gathers (stdout)                             ",
  "                 =3 Migrated zero offset section (stdout)            ",
  " nh=50           Number of traces for csp                            ",
  " ncsp=10         Number of CSP to compute for every file  reading    ",
  " hmin=0          Maximum and minimum equivalent offset               ",
  " hmax=1000       Minimum and minimum equivalent offset               ",
  " testhe=0        =1 Computes equiv offset at every time              ",
  "                 =2 Uses one side CSP                                ",
  "                 other two sides CSP                                 ",
  " fold            =1  Normalize by fold                               ",  
...
int main(int argc, char **argv)
{
  ...
  if (output==1) system("Xsetntr csps.su &");
