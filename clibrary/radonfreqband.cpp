...
/*
Daniel Trad - November 21- 2000
*/


void radonfreqband0(float **data, float *h, int nh,float *t, int nt, float dt, float **model, float *q, int nq, float *vel, int itercg, int iter_end, float step, float eps2, float eps1, float quantil, int norm, float factor, float smute, float nmofactor, int rtmethod, float depth, float fmax)
{
  int i, it, ih;
  float  qmax, qmaxt;
  float  dx_av, dx_max;
  ...
  radonfreqband0(h,nh,data,t,nt,dt,model,q,nq,dq,eps1,eps2,eps,fmax,Wd,itercg,iter_end,
