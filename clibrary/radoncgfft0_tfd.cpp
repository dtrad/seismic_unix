...
void radoncgfft0_tfd(float **data, float *h, int nh,float *t, int nt, float dt, float **model, float *q, int nq, float *vel, float fmax,  float quantil, float factor, float smute, float nmofactor, int rtmethod, float depth, inv_par inv)
{
  int i, it, ih;
  float  qmax, qmaxt;
  float  dx_av, dx_max;
