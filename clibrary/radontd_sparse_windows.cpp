  ...
  */
  ...
  for (ih=0;ih<nh;ih++){
	...
	if (vel[iq][it]>0){
	  ...
	  if (itime<nt){
	    index[0][ih*nq*nt0+iq*nt0+it00]=ihxnt+itime;
	    index[1][ih*nq*nt0+iq*nt0+it00]=iqxnt+it;
	  }
	  else{
	    index[0][ih*nq*nt0+iq*nt0+it00]=0;
	    index[1][ih*nq*nt0+iq*nt0+it00]=0;
	  }
	}
      }            
    }
