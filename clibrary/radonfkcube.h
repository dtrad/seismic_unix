#ifndef RADONFKCUBE_H
#define RADONFKCUBE_H
...
void save_gather(float ***d, int nv, int nh, int nt, float dt, char* name);

void save_gather(float ***d, int nv, float *v,int nh, float *h, int nt, float *t, char* name);
...
void stoltzop2(float **data, float ***model, int nt, int nh, int nv, float *t, 
...
void weights_test(float ***m, int nt, int nh, int nv, int norm, float sigmam, float ***Wm,
