...
void radint(float *t, float *q, float *h, float *h2, float *m,float *d,float *dint,float eps,float qmin,float qmax, float fmax, float *vel, float dperv, float pervmin, float alum, float blum, float clum, int norm)
  ...
  */
{
  ...
  if (method == 0){ 
    ...
    radhypsp(t,h,q,vgrid,nt,nh,nq,index);
    // Test the adjoint
