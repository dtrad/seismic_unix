...
#include <math.h>
void wtcgls(float *t, float *qaxis, float *h,float *x,float *b,float tol)
  
{
  float normb,dq,dq2,nit,beta,betanum, betaden, alpha, alphanum, alphaden;
  int k,i,j,in,num;
  extern int itercg,nx,ny;
  float *Qp,*q,*q1,*s,*x1,*z,*z1,*r,*Az,*eta,*rho,*gcv;
...
void wtcgls(float *t, float *qaxis, float *h,float *x,float *b,float *Qp, float tol)
