...
void rstack2( double *x, double *t, double *h, double *p, double *y, 
...

{
	...
	dt=t[1]-t[0];/*printf("dt=%f\n",dt);*/
        ...
        if (flag2==1) printf("No Weight matrix flag2=%d;\n",flag2);
	...
	if (flag2==0) rstack(x,t,h,p,z,nt,nh,np,dt,ww);
	else if (flag2==1) rstack2(x,t,h,p,z,nt,nh,np,dt);
...
void rstack2( double *m, double *t, double *h, double *q, double *d, 
