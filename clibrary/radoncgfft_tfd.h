#ifndef RADONCGFFT_TFD_H
#define RADONCGFFT_TFD_H
...
void radoncgfft0_tfd_mute(float **data, float *h, int nh,float *t, int nt, float dt, 
		     float **model, float *q, int nq, float *vel, float fmax,  
                     float quantil, float factor, float smute, float nmofactor, 
...
/* suradoncgfft_tfd2 uses doublemute  */
