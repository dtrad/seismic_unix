  ...
  */
{
  ...
  void (*radon3sw) (float *m, float *d, float **index, int adj, int nt, 
...
void build_index_slowness(float *t, float *h, float *q, float **vel, int nt, int nh, int nq, float **index, int it0)
{
  register int it;
  int ih,iq;
  ...
  memset((void *) index[0],(int)'\0',nsparse*FSIZE);
  memset((void *) index[1],(int)'\0',nsparse*FSIZE);
