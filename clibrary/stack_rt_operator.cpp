...
void stack_rt_operator(complex **F, int maxfreq, float df, float *h, int nh, 
		      float *q, int nq, float *t, int nt, float eps, float parmute)
{
...
void stack_rt_LS_operators(complex ***LS, complex ***LT, int maxfreq, float df, 
			   float *h, int nh, float *q, int nq, float *t, int nt, float eps, 
			   float parmute, float *mute, float *stackop)
{
  /* Variables with capital letters corresponds to matrices */
