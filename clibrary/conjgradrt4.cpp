...
void conjgradrt4(float *pos, float **data, float dt,float **model, float *q, float dq,float eps1, float eps2, float eps, float fmax, float *Wd)
{
  ...
  complex *d,*dw,*u;
  extern int nt,nh,nq,iter_end,rtmethod,norm,itercg,freqflag,costflag;
