...
void stoltzopinv(float **datain, float **dataout, int nt, int nh, int nh2, float *t, 
	       float *h, float *h2, float vel, complex **F, complex **FLS, int adj)
{
  ...
  for (it=0;it<nt;it++){
    ...
    Atimesx_DFT(d2,F,m,nh2,nk,0);
    for (ih=0;ih<nh2;ih++) px[ih][it]=d2[ih].r;
  }
