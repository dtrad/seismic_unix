      ...
      subroutine S_STACK_0(d,nh,nt,pos,dt,m,nq,qmin,qmax,eps1,cn,niter,nntt,nnnxx)
c
c
...
c        call GAUSS_GAUSS_0(L,lh,dc,mc,nh,nq,eps1)
...
c       subr FX_symmetry (sfx,nx,nt,nfft,iflow,ifhigh)
        ...
        call FX_symmetry (aux2,nq,nt,nfft,kl,kh,nntt,nnxx)
