      ...
      subroutine  V_STACK_O(method,d,nh,pos,nt,dt,m,nq,qmin,qmax,eps1,
     & iter_end)
c
c
...
c
        ...
        real * 8     tmax,dt,dq,dh(nnx),pos(nnx),qmin,qmax,eps1
...
c------ subroutine CAUCHY_GAUSS_0(l,lh,d,model,nd,np,eps1,iter_end)
        ...
        if(method.eq.2) then 
        call GAUSS_GAUSS_T0(l,lh,dc,mc,nh,nq,eps1,dh)
        call CAUCHY_GAUSS_0(l,lh,dc,mc,nh,nq,eps1,iter_end)
        endif
