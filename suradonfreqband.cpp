...
char *sdoc[] = {
  " 	   								",
  " SURADONFREQBAND - Time domain Parabolic Radon Transform             ",
  " 	   								",
...
int main(int argc, char **argv)
{
  ...
  radonfreqband0(data,h,nh,t,nt,dt,model,q,nq,velint,quantil,norm,factor,
		 smute,nmofactor,rtmethod,depth,fmax);  
