...
char *sdoc[] = {
"									",
" GBBEAMMOD - Gaussian beam synthetic seismograms for a sloth model 	",
"									",
" gbbeammod <rayends >syntraces xg= zg= [optional parameters]		",
"									",
" Required Parameters:							",
...
"									",
" This program differs from gbbeam in the parameters dg and fg          ",
" these two parameters permit to generate a line of receivers		",
" with a given spacing in exactly the same way as triseis.              ",
NULL};
...
int main (int argc, char **argv)
{
	...
	/* added from triseis to generate array of receivers */
	/* D. Trad */
	...
	makexzs(nxz,xg,zg,ng,dg,fg,xg,zg);
