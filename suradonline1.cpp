...
int main(int argc, char **argv)
{
  ...
  // search for the first cdp  
    ...
    radonsolver0_mute(cmp,h,nhcmp[ix],t,nt,dt,mm,q,nq,velint,itercg,iter_end,step,eps2,eps1, quantil,norm,factor,smute,nmofactor,rtmethod,depth,fmax,solver,0,parmute,0,mute); 
